...
if (import.meta.hot) {
  log('found import.meta.hot', import.meta.hot);
  ...
  import.meta.hot.dispose(() => {
    ...
    if (cancellers.length) {
      log('Killing ' + cancellers.length + ' running processes...');
      try {
  ...
  function log(...args) {
    if (true || import.meta.hot.verbose) {
    ...
    if (originalInit) {
      module.init = function (args) {
        ...
        if (typeof args !== 'undefined') {
          ...
          domNode = typeof window !== 'undefined' ? document.body : {parentNode: null};
          flags = undefined;
        }
  ...
  function swap(Elm, instance) {
    ...
    log('Hot-swapped module: ' + instance.path);
  }
